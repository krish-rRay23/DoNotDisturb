...
<h2>5. Supplementary Diagnostics (Appendix Material)</h2>
<p>To preserve a concise &le; 9-page main text, full continuous diagnostic trajectories and the 15-step causal telemetry trace are placed in the Appendix:</p>
<div style="display: flex; gap: 20px;">
  <div class="fig-box" style="flex: 1;">
    <img src="figures/capacity_trajectories.png" alt="Capacity Trajectories">
    <div class="fig-caption">Appendix Figure A.1a: Online trajectories of relative effective rank (&rho;) and activation dormancy (d), showing &rho; &gt; 0.70 and d &lt; 0.085 throughout stable transfer.</div>
  </div>
  <div class="fig-box" style="flex: 1;">
    <img src="figures/clean_vs_shifted.png" alt="Clean vs Shifted">
    <div class="fig-caption">Appendix Figure A.1b: Performance retention across clean, observation noise, and reward scaling regimes.</div>
  </div>
</div>

<div class="alert-box">
  <strong>Causal Telemetry Trigger Summary (Section 5.4 &amp; Appendix Table A.4):</strong> Under joint crippling at step 5k, relative rank decays below trigger threshold at step 7k (&rho; = 0.6948 &le; 0.70), actuating parameter intervention (||&Delta;&theta;|| = 2.954). 3k-step refractory cooldown spaces actuations, achieving final score 8.58 vs 7.99 unperturbed.
</div>
...
<div class="alert-box">
  <strong>Appendix Overview:</strong><br>
  • <strong>Table A.1:</strong> Extended Literature Comparison &amp; Conceptual Positioning Matrix<br>
  • <strong>Table A.2:</strong> Complete 135-Run Primary Benchmark Breakdown (Seeds 0&ndash;4)<br>
  • <strong>Table A.3:</strong> Experimental Hyperparameters and Diagnostic Settings<br>
  • <strong>Figure A.1:</strong> Diagnostic Telemetry Trajectories and Cross-Regime Retention<br>
  • <strong>Table A.4:</strong> Step-by-Step Diagnostic Telemetry Trace Under Actuator Stress
</div>
